...
Aqui também se declara a **localidade** cujo calendário determina quais feriados incidem na contagem de prazos do certame, por referência de cidade (`UNI-REQ-0111`). Ela não tem valor por omissão nem é deduzida da unidade administradora, do campus ou da cidade de oferta: quem configura informa, e é obrigatória para publicar, não para criar. O **fuso horário** em que cada dia civil começa e termina não é perguntado — é o mesmo em todo certame da instituição, então o sistema o aplica e o congela na versão publicada.
