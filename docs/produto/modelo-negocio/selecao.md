...
- Há dois prazos distintos: o prazo para o candidato recorrer (contado da publicação do ato; só existe para a 1ª instância, a única que o Uni+ recebe — a instância superior não tem interposição própria dentro do sistema) e o tempo de bloqueio por instância (que começa quando um recurso é efetivamente interposto, ou quando a 1ª instância é julgada e a 2ª ainda pode ser aberta). Cada um desses prazos é um par valor-unidade com convenção de contagem explícita (dias corridos ou dias úteis) — o mesmo número conta prazos diferentes conforme a convenção, então ela é parte do prazo, não um detalhe implícito. O bloqueio encerra no julgamento ou no fim do prazo, o que vier primeiro — um recurso nunca julgado não pode travar o certame indefinidamente.
