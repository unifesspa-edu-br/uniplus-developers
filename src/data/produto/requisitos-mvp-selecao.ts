...
export const requisitosMvpSelecao: Requisito[] = [
  ...
  },
  {
    ...
    tipo_issue_recomendado: 'None',
    criterios_aceite:
      'Enquanto este incremento não é entregue, a publicação aceita um processo que oferte PCD_PURO junto com qualquer modalidade da Lei 12.711, sem nenhuma verificação de exclusividade; entregar este incremento adiciona um invariante de publicação que recusa essa combinação, com verificação automatizada.',
    verificacao: 'Revisão futura.',
    pagina_developers: '/produto/mvp-selecao/',
    owner: 'Tech Lead',
  },
