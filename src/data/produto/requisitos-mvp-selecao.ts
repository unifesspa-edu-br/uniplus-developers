...
export const requisitosMvpSelecao: Requisito[] = [
  ...
  },
  {
    ...
    tipo_issue_recomendado: 'None',
    criterios_aceite:
      'O par de suspensividade e o prazo de interposição de um recurso são resolvidos, os dois juntos, pelos campos já congelados por UNI-REQ-0080 na versão vigente quando o ato recorrido foi publicado, nunca pela vigente no instante da interposição nem no julgamento; uma retificação publicada entre a publicação do ato recorrido e a interposição não altera nenhum desses dois campos para um recurso que venha a ser interposto contra aquele ato; um recurso contra um ato publicado já sob a regra retificada é regido pela regra nova, sem herdar a proteção de atos anteriores; escopo do bloqueio e irreversibilidade do ato seguem resolvidos como sempre (objeto do recurso e cadastro do tipo de ato, respectivamente), sem relação com qual versão publicou o ato recorrido.',
    verificacao: 'Revisão futura.',
    pagina_developers: '/produto/regras-negocio/',
    owner: 'Tech Lead',
  },
