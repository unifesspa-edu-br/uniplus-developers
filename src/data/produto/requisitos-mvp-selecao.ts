...
export const requisitosMvpSelecao: Requisito[] = [
  ...
  },
  {
    ...
    tipo_issue_recomendado: 'Story',
    criterios_aceite:
      'O snapshot congelado carrega, por fase e por instância, o par de suspensividade (valor e unidade, ou nulo para não bloquear), a irreversibilidade do ato, o prazo de interposição, a regra de ancoragem do ato recorrido e o escopo do bloqueio. Um processo publicado sem esses campos é rejeitado, pois a versão é imutável e o gate futuro não teria como reconstruí-los. A configuração é a mesma para Seleção e Ingresso; a diferença de bloqueio decorre só dos valores congelados, nunca de ramificação por módulo em código.',
    verificacao: 'Teste de contrato do snapshot (campos presentes e imutáveis após publicação, incluindo prazo de interposição, ancoragem e escopo do bloqueio) (planejado).',
    pagina_developers: '/produto/regras-negocio/',
    owner: 'Tech Lead',
  },
  {
