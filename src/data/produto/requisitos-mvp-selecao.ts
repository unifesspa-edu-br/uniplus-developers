...
export const requisitosMvpSelecao: Requisito[] = [
  ...
  },
  {
    ...
    tipo_issue_recomendado: 'Task',
    criterios_aceite:
      'A decisão registra a janela de solicitação de isenção e o prazo de recurso em dias, com a justificativa, atualizando UNI-REQ-0104 antes da implementação.',
